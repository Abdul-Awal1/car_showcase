            ...
            <div className='relative flex w-full mt-2 '>
                <div className='flex group-hover:invinsible w-full justify-between text-gray'>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <Image src="/steering-wheel.svg" width={15} height={15} alt="steering wheel" />
                    ...
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <Image src="/tire.svg" width={15} height={15} alt="tire" />
                    ...
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <Image src="/gas.svg" width={15} height={15} alt="gas" />
                        <p className='text-[12px]'>
                            {city_mpg}MPG
