                    ...
                    <div className='fixed inset-0 overflow-y-auto'>
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                ...
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-2xl">
                                    ...
                                    <div className='flex-1 flex flex-col gap-3'>
                                        ...
                                        <div className='flex gap-3 '>
                                            <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                                <Image src={generateCarImageUrl(car, '29')} alt={"car model"} priority className='object-contain' 
                                                width={1000}
                                                height={1000} />
                                            </div>
                                            <div className='flex-1 relative w-full h-24 bg-primary-blue-100 rounded-lg'>
                                    ...
                                    <div className='mt-3 flex flex-wrap gap-4'>
                                     {Object.entries(car).map(([key,value])=>(
                                        <div className='flex justify-between gap-5 w-full text-right'key={key}>
                                           ...
                                           <p className='text-blacl-100 font-semibold'>
                                            {value}
                                           </p>
                                            </div>
                                     ))}
